...
/*
	public String  fullPermission() throws Exception{
		...
		//String Username = prop.getProperty("fullPermissionUseName");
		//String pwd  =  prop.getProperty("fullPermissionPwd");
		//String url = "https://parmeshwar.sakole:Maahi!123456789@internal.spapps.local/sites/npsfinance/SitePages/Vendor-Data.aspx";
		String url = "http://tc3-v-devsp06/sites/NPSFinance/SitePages/Vendor-Data.aspx";
	...
	public String TestUser() throws  Exception{
		...
		//String Username = prop.getProperty("testUsername");
		//String pwd  =  prop.getProperty("testPwd");
		String url = "http://parmeshwar.sakole:Maahi!123456789@internal.spapps.local/sites/npsfinance/SitePages/Vendor-Data.aspx";
		String Url = url;
		return Url;
	}*/
